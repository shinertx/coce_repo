...
from typing import Counter as CounterType, Deque, Dict, Tuple, cast
...
class ConsensusClusters:
    ...
    def _snapshot_partition(self, corr: pd.DataFrame) -> Dict[str, int]:
        ...
        return cast(Dict[str, int], community_louvain.best_partition(g))
    ...
    def update(self, corr: pd.DataFrame) -> Dict[str, int]:
        ...
        votes: CounterType[Tuple[str, str]] = Counter()
